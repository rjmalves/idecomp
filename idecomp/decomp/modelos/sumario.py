...
class BlocoCMOSumario(Bloco):
    ...
    def __init__(self):
        ...
        super().__init__(BlocoCMOSumario.str_inicio, "", True)
...
class BlocoGeracaoTermicaSubsistemaSumario(Bloco):
    ...
    def __init__(self):
        ...
        super().__init__(
            BlocoGeracaoTermicaSubsistemaSumario.str_inicio, "", True
        )
...
class BlocoEnergiaArmazenadaREESumario(Bloco):
    ...
    def __init__(self):
        ...
        super().__init__(BlocoEnergiaArmazenadaREESumario.str_inicio, "", True)
...
class BlocoEnergiaArmazenadaSubsistemaSumario(Bloco):
    ...
    def __init__(self):
        ...
        super().__init__(
            BlocoEnergiaArmazenadaSubsistemaSumario.str_inicio, "", True
        )
